...
import { PGS } from '../../components/constants';
import { getMethods, getQuotas } from '../../components/utils';
...
type PaymentTestNavigationProp = StackNavigationProp<RootStackParamList, 'PaymentTest'>;
type PaymentTestRouteProp = RouteProp<RootStackParamList, 'PaymentTest'>;

type Props = {
    navigation: PaymentTestNavigationProp;
    route: PaymentTestRouteProp;
};
...
const PaymentTest: React.FC<Props> = ({ navigation }) => {
        ...
        >
            ...
            <FormControl p={2} borderRadius={3}>
                ...
                <Input mx={2} mb={1} flex={1} p={1} variant={'underlined'}>
                    <InputField
                    value={userCode}
                    onChangeText={(value : any) => setUserCode(value)}
                    />
                </Input>
                </VStack>
                <VStack>
                ...
                <Input mx={2} mb={1} flex={1} p={1} variant={'underlined'}>
                    <InputField
                    value={tierCode}
                    onChangeText={(value : any) => setTierCode(value)}
                    />
                </Input>
                </VStack>
                <VStack>
                ...
                <VStack>
                    ...
                    <Picker
                        data={getQuotas(pg).map((quota) => ({
                            label: quota.label,
                            value: quota.value.toString(), // value를 string으로 변환
                        }))}
                        selectedValue={cardQuota.toString()} // selectedValue를 string으로 변환
                        onValueChange={(value) => setCardQuota(parseInt(value, 10))} // string을 다시 number로 변환하여 상태 업데이트
                    />
                </VStack>
                )}
                {method === 'vbank' && (
                <VStack>
                    ...
                    <InputField
                        value={vbankDue}
                        onChangeText={(value : any) => setVbankDue(value)}
                    />
                    </Input>
                </VStack>
                )}
                ...
                <VStack>
                    ...
                    <InputField
                        ...
                        returnKeyType={'done'}
                        value={bizNum}
                        onChangeText={(value : any) => setBizNum(value)}
                    />
                    </Input>
                </VStack>
                )}
                ...
                <VStack>
                    ...
                    onValueChange={(value : any) => setDigital(value)}
                    />
                </VStack>
                )}
                <VStack>
                ...
                <Switch
                    ...
                    value={escrow}
                    alignSelf={'flex-start'}
                    onValueChange={(value : any) => setEscrow(value)}
                />
                </VStack>
                <VStack>
                <FormControl.Label my={1}>
                ...
                <Input mx={2} mb={1} flex={1} p={1} variant={'underlined'}>
                    <InputField
                    value={merchantUid}
                    onChangeText={(value : any) => setMerchantUid(value)}
                    />
                </Input>
                </VStack>
                <VStack>
                ...
                <Input mx={2} mb={1} flex={1} p={1} variant={'underlined'}>
                    <InputField
                    value={buyerName}
                    onChangeText={(value : any) => setBuyerName(value)}
                    />
                </Input>
                </VStack>
                <VStack>
                ...
                <Input mx={2} mb={1} flex={1} p={1} variant={'underlined'}>
                    ...
                    returnKeyType={'done'}
                    value={buyerTel}
                    onChangeText={(value : any) => setBuyerTel(value)}
                    />
                </Input>
                </VStack>
                <VStack>
                ...
                <Input mx={2} mb={1} flex={1} p={1} variant={'underlined'}>
                    <InputField
                    value={buyerEmail}
                    onChangeText={(value : any) => setBuyerEmail(value)}
                    />
                </Input>
                </VStack>
                <Button
